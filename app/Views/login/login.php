...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user) {
        ...
        if (password_verify($password, $user['Contraseña'])) {
            ...
            header('Location: /Kima/Kima2/public/index.php');
            exit();
        } else {
...
<head>
    ...
    <link rel="icon" href="/Kima/Kima2/public/assets/media/logos/ticket-de-soporte.png" type="image/svg+xml">
</head>
<body>
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid align-items-center justify-content-center">
            <div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10 text-center">
                <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                    <form class="form w-100" method="POST" action="/Kima/Kima2/app/Views/login/login.php">
