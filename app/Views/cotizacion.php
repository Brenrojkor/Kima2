...
<body>
    ...
    <!-- ✅ Bootstrap JS (opcional pero común si usas modales, etc) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>

    <!-- ✅ DataTables core -->
    <script src="https://cdn.datatables.net/1.13.5/js/jquery.dataTables.min.js"></script>

    <!-- ✅ DataTables Bootstrap 5 (opcional si quieres integrarlo con estilos Bootstrap) -->
    <script src="https://cdn.datatables.net/1.13.5/js/dataTables.bootstrap5.min.js"></script>

    <!-- ✅ DataTables CSS (en el `<head>` si aún no está) -->
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".verCotizacion", function() {
            ...
            $.ajax({
                url: `/Kima/app/Controllers/CotizacionesController.php?action=obtenerCotizacion&id=${id}`,
                type: "GET",
                dataType: "json",
        ...
        // Confirmar cancelación de la cotización
        ...
        $("#search").on("keyup", function() {
            ...
            $.ajax({
                url: "/Kima/app/Controllers/CotizacionesController.php?action=buscarClientes",
                type: "POST",
                data: {
                    query: query
                },
        ...
        $("#guardarCambiosCotizacion").on("click", function() {
            ...
            $.ajax({
                url: "/Kima/app/Controllers/CotizacionesController.php?action=actualizarCotizacion",
                type: "POST",
                data: {
                    cotizacion_id,
                    cliente_id,
        ...
        $(document).on("click", ".cliente-item", function() {
            ...
            // Mostrar "Nombre - Empresa" en el input de búsqueda
        ...
        // Buscar clientes en el modal de edición
        ...
        // Seleccionar cliente en edición
        ...
        $("#searchProducto").on("keyup", function() {
            ...
            $.ajax({
                url: "/Kima/app/Controllers/CotizacionesController.php?action=buscarProductos",
                type: "POST",
                data: {
                    query: query
                },
        ...
        // Buscar productos en el modal de edición
        ...
        $(document).on("click", ".eliminarCotizacion", function() {
            ...
            if (confirm(
                ...
                $.ajax({
                    url: "/Kima/app/Controllers/CotizacionesController.php?action=eliminarCotizacion",
                    type: "POST",
                    data: {
                        id
                    },
        ...
        $("#guardarCotizacion").on("click", function() {
            ...
            $.ajax({
                url: "/Kima/app/Controllers/CotizacionesController.php?action=guardarCotizacion",
                type: "POST",
                data: {
        ...
        let table = $("#kt_quote_list").DataTable({
            ...
            "serverSide": false,
            "ajax": {
                "url": "/Kima/app/Controllers/CotizacionesController.php?action=listarCotizaciones",
                "type": "GET",
                "dataSrc": ""
            },
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                    <a href="/Kima/app/Views/clientes.php?id=${row.cliente_id}" class="btn btn-sm btn-link text-primary fw-semibold">
                        ${row.cliente}
                    </a>`;
                    }
                },
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                            ...
                            <a class='btn btn-icon btn-light-info me-2' href='/Kima/app/Controllers/CotizacionesController.php?action=descargarPDF&id=${data}' target="_blank">
        ...
        // 🔄 Función para recargar la tabla sin refrescar la página
        function cargarCotizaciones() {
            table.ajax.reload(null, false); // Recargar datos sin mover de página
        }
