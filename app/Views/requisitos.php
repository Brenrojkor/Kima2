            ...
            $(document).ready(function() {
                function loadCategorias(selectedCategoria = null) {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: "/Kima/Kima2/app/Controllers/RequisitosController.php?action=getCategorias",
                            type: "GET",
                            dataType: "json",
                ...
                function loadPrioridades(selectedPrioridad = null) {
                    return new Promise((resolve, reject) => {
                        $.ajax({
                            url: "/Kima/Kima2/app/Controllers/RequisitosController.php?action=getPrioridades",
                            type: "GET",
                            dataType: "json",
                            success: function(response) {
                                let options =
                ...
                $("#form_requisito").submit(function(event) {
                    ...
                    $.post(`/Kima/Kima2/app/Controllers/RequisitosController.php?action=${action}`, formData,
                        function(response) {
                ...
                function loadRequisitos() {
                    $.getJSON("/Kima/Kima2/app/Controllers/RequisitosController.php?action=getAllJson", function(
                        response) {
        ...
        `);
                ...
                $(document).on("click", ".btn-delete", function() {
                    ...
                    if (confirm("¿Estás seguro de que deseas eliminar este requisito?")) {
                        $.post(`/Kima/Kima2/app/Controllers/RequisitosController.php?action=delete`, {
                            id_requisito: id
                        }, function(response) {
                            alert(response.message);
                            if (response.status === "success") {
