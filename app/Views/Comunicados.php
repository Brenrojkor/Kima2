        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/Kima/app/Controllers/ComunicadosController.php?action=subirArchivo" class="dropzone"
                        id="formDropzone">
...
">
    ...
    $(document).ready(function() {
        ...
        $("#formRelacionarArchivoCarpeta").on("submit", function(e) {
            ...
            $.post("/Kima/app/Controllers/ComunicadosController.php?action=relacionarArchivoACarpeta",
                formData,
                function(res) {
    ...
    $(document).ready(function() {
        ...
        function cargarComunicadosNew() {
            $.ajax({
                url: "/Kima/app/Controllers/ComunicadosController.php?action=obtenerComunicados",
                type: "GET",
                dataType: "json",
                success: function(response) {
                    let html = "";
    ...
    <div class="d-flex justify-content-center align-items-center">
        ...
        $(document).on("click", ".btn-eliminar", function() {
            ...
            $.ajax({
                url: "/Kima/app/Controllers/ComunicadosController.php?action=obtenerInfoArchivo&id=" +
                    id,
                type: "GET",
                dataType: "json",
                success: function(res) {
        ...
        $("#btnCrearCarpeta").click(function() {
            ...
            $.post("/Kima/app/Controllers/ComunicadosController.php?action=crearCarpeta", {
