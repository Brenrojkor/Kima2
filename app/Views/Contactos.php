...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#modalHistorial').on('shown.bs.modal', function() {
            $.ajax({
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=getHistorialJson",
                type: "GET",
                dataType: "json",
        ...
        $(document).on("click", ".btn-edit", function() {
            ...
            $.ajax({
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=getClienteById",
                type: "GET",
                data: {
                    id: clienteID
                },
        ...
        $("#kt_modal_edit_customer_form").off("submit").on("submit", function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=updateCliente",
                data: formData,
                dataType: "json",
                success: function(response) {
                    if (response.status === "success") {
        ...
        $("#kt_modal_add_customer_form").submit(function(event) {
            ...
            $.ajax({
                type: "POST",
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=create",
                data: formData,
                dataType: "json",
                success: function(response) {
                    if (response.status === "success") {
        ...
        $(document).on("click", ".btn-delete", function() {
            ...
            $.ajax({
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=deleteCliente",
                type: "POST",
                data: {
                    id: clienteID
                },
        ...
        function cargarClientes() {
            $.ajax({
                url: "/Kima/Kima2/app/Controllers/ContactosController.php?action=getAllJson",
                type: "GET",
                dataType: "json",
                success: function(response) {
                    if (response.status === "success") {
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/Kima/Kima2/app/Views/contactos_detalle.php?id=${c.id}" class="btn btn-icon btn-light-info"><i class="fa fa-eye"></i></a>
                        </td>
                    </tr>`;
                        });
                        ...
                        table = $("#kt_customers_table").DataTable({
                            ...
                            responsive: true,
                            pageLength: 10,
                            dom: 'Brtip', // 👈 Botones, tabla, info, paginación
                            buttons: [{
                                extend: 'excelHtml5',
                                title: 'Contactos',
                                className: 'd-none',
                        ...
                        // Búsqueda personalizada con input
