...
if (!isset($_SESSION['nombre'])) {
    header("Location: /app/Views/login/login.php"); // Redirige si no está logueado
    exit();
}
...
<head>
    ...
    <link href="/public/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
        type="text/css" />
...
?>
                ...
                <a
                    href="/app/Views/usuarios_perfil.php?id=<?= $idUsuario ?>"><?php echo htmlspecialchars($_SESSION['nombre']); ?></a>
            </span>
